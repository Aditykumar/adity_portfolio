...
import finflow from '../../public/img/finflow.png'
    ...
    return (
        <div className="projects" id="projects">
            ...
            <div className="core-skills core-skills--project" >
                <div className="core-skills-item core-skills-item--col light-shadow">
                    ...
                    <div className="core-skills-item--content">
                        <h2 className="core-skills-item-title"><Link href={"https://www.collegedekho.com/"}>Collegedekho</Link></h2>
            ...
            <div className="core-skills core-skills--project" >
                <div className="core-skills-item core-skills-item--col light-shadow">
                    <div className="core-skills-item--image core-skills-item--image--col">
                        <Image className="core-skills-item--image-img" src={finflow} alt="Image" />
                    </div>
                    <div className="core-skills-item--content">
                        <h2 className="core-skills-item-title"><Link href={"http://finance-frontend.collegedekho.com"}>FinFlow</Link></h2>
                        <p className="core-skills-item-about">
                       
FinFillow is software specific to financial management, it may offer additional functionalities related to financial tracking, invoicing, payment management, or integration with accounting systems.
                          </p>
            ...
            <div className="core-skills core-skills--project" >
                <div className="core-skills-item core-skills-item--col light-shadow">
                    ...
                    <div className="core-skills-item--content">
                        <h2 className="core-skills-item-title"><Link href={"http://lms-rhz-react.collegedekho.com/login"}>Lead Management System </Link> </h2>
                        <p className="core-skills-item-about">
            ...
            <div className="core-skills core-skills--project" >
                <div className="core-skills-item core-skills-item--col light-shadow">
                    ...
                    <div className="core-skills-item--content">
                        <h2 className="core-skills-item-title"><Link href={"https://www.prepbytes.com/"}>PrepBytes</Link></h2>
                        <p className="core-skills-item-about">
            ...
            <div className="core-skills core-skills--project" >
                <div className="core-skills-item core-skills-item--col light-shadow">
                    ...
                    <div className="core-skills-item--content">
                        <h2 className="core-skills-item-title"><Link href={"https://www.getmyuni.com/"}>Getmyuni</Link></h2>
                        <p className="core-skills-item-about">
