                    ...
                    <div className="core-skills-item--content">
                        ...
                        <div className="project-links">
                            <ul className="menu-content">
                                <li>
                                    <a target="_blank" href="https://github.com/Chaitanya31612/crowdy-dapp" className="social-icon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 30 28" fill="none" stroke="#111" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" className="feather feather-github">
