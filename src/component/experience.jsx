...
const Experience = () => {
  return (
    <div class="experience inverted" id="experience">
        <div class="title">
          <h1 class="heading-1 heading-1--dark heading-1--m">Experience</h1>
    ...
    <section class="content-container">
          <div class="content-list">
            <h1 class="content-list__title">Full Stack MERN Developer</h1>
            <h5 class="content-list__name">
              <a target="_blank" href="https://www.marketinc.net/" class="content-list__name-link">MarketInc</a>
              - Internship
            </h5>
            <div class="content-list__about">
            ...
            <div class="content-list__date">June 2022 - August 2022</div>
          </div>

          <div class="content-list">
            <h1 class="content-list__title">Web Development</h1>
            <h5 class="content-list__name">
              <a target="_blank" href="https://www.viratpack.com/" class="content-list__name-link">ViratPack</a>
              - Freelancing
            </h5>
            <div class="content-list__about">
          ...
          <div class="content-list">
            <h1 class="content-list__title">Full Stack Web Developer</h1>
            <h5 class="content-list__name">
              <a target="_blank" href="https://www.myways.in/" class="content-list__name-link">MyWays</a>
              - Internship
            </h5>
            <div class="content-list__about">
            ...
            <div class="content-list__date">July 2020 - October 2020</div>
          </div>
          ...
          <div class="content-list">
            ...
            <h5 class="content-list__name">
              <a target="_blank" href="http://swoc.tech/" class="content-list__name-link">SWOC</a>
              - Open Source Program
            </h5>
            <div class="content-list__about">
            ...
            <div class="content-list__date">December 2020 - February 2021</div>
          </div>
          ...
          <div class="content-list">
            ...
            <h5 class="content-list__name">
              <a target="_blank" href="https://njackwinterofcode.github.io/" class="content-list__name-link">NWOC</a>
              - Open Source Program
            </h5>
            <div class="content-list__about">
            ...
            <div class="content-list__date">December 2020 - January 2021</div>
          </div>
        </section>
        </div>
